  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="pt-6 pb-2 px-2 group/file block cursor-pointer w-full relative"
      >
        <input
          ref={fileInputRef}
          ...
          <div className="relative w-full">
                ...
                >
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit shrink-0 text-sm bg-neutral-700 text-neutral-300"
                    >
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-40 bg-black border border-neutral-700 flex items-center justify-center h-32 w-full rounded-md",
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute opacity-0 border border-dashed border-blue-500 inset-0 z-30 bg-transparent flex items-center justify-center h-32 w-full rounded-md"
              ></motion.div>
            )}
          </div>
        </div>
